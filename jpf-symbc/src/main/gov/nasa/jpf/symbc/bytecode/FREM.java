...
/**
 * IEEE 754 float remainder, result = A % B.  With at least one symbolic
 * operand, the JVM's concrete frem semantics are explored as three outcome
...
public class FREM extends gov.nasa.jpf.jvm.bytecode.FREM {
    ...
    private static final double SYM_MIN = -Float.MAX_VALUE;
    private static final double SYM_MAX = Float.MAX_VALUE;
    ...
    public Instruction execute(ThreadInfo th) {
        ...
        // Both operands concrete: plain IEEE 754 frem.
        ...
        String varId = "frem_" + resultCounter++;
    ...
    private static int classify(float v2, float v1) {
        if (Float.isNaN(v2) || Float.isNaN(v1) || v1 == 0.0f || Float.isInfinite(v2))
            return 1;
